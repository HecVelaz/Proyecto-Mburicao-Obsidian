...
-  [[notebooks/features/event_duration_counts.csv|event_duration_counts.csv]]
-  [[global_duration_counts.csv]]
## Archivos relevantes
...
- [`data_extraction.ipynb`](notebooks/features/data_extraction.ipynb)
- [`duration_event.ipynb`](notebooks/features/duration_event.ipynb)
- [[level_duration_event_plot.ipynb]]

## Flujo de uso
- [`categorize_critical_event.ipynb`](notebooks/features/categorize_critical_event.ipynb) :
	- Se cargan los datos [[sil_nivel_merged.csv]] y [[peak_nivel_detection.csv]] 
...
- [`data_extraction.ipynb`](notebooks/features/data_extraction.ipynb)
	- Se cargan [[sil_nivel_merged.csv]] y [[peak_nivel_detection.csv]] 
...
- [`duration_event.ipynb`](notebooks/features/duration_event.ipynb)
	- Se cargan [[peak_detection_info.csv]] y`data_for_clustering_1.csv`
...
## Entradas
- [[sil_nivel_merged.csv]] y [[peak_nivel_detection.csv]] 
- [[sil_nivel_merged.csv]] y [[peak_nivel_detection.csv]] 
## Salidas
