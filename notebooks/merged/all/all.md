## Propósito
Se crea el conjunto de datos [[sil_snd_aisp_local_nivel_merged.csv]] y se realizan el cross correlation y mutual information.

## Contenido
- [[(Local)sil_snd_aisp_nivel.ipynb]]
- [[(Local)sil_snd_aisp_nivel_merged_plot.ipynb]]
- [[Cross_correlation.ipynb]]
- [[Mutual_information.ipynb]]
- [[sil_snd_aisp_nivel.ipynb]]
- [[sil_snd_aisp_nivel_merged_plot.ipynb]]
## Archivos relevantes
...
### Notebooks
- [[(Local)sil_snd_aisp_nivel.ipynb]]:
	- Se cargan [[nivel_processed.csv]] ,[[sil_processed.csv]] , [[snd_local_processed.csv]], [[aisp_local_processed.csv]]
	...
	- resultado [[sil_snd_aisp_local_nivel_merged.csv]]
- [[(Local)sil_snd_aisp_nivel_merged_plot.ipynb]]
	- se realizan gráficos , introduciendo fecha y hora.
- [[Cross_correlation.ipynb]]
	- Lee 3 archivos CSV fusionados:  [[aisp_local_nivel_merged.csv]] , [[snd_local_nivel_merged.csv]] , [[sil_nivel_merged.csv]] 
...
- [[sil_snd_aisp_nivel.ipynb]]
	- Es lo mismo que el codigo [[(Local)sil_snd_aisp_nivel.ipynb]] pero sin los conjuntos de datos utc a local , asi que no usamos este código, solo para comparación.
- [[sil_snd_aisp_nivel_merged_plot.ipynb]]
...
## Entradas
-  [[nivel_processed.csv]] ,[[sil_processed.csv]] , [[snd_local_processed.csv]], [[aisp_local_processed.csv]]
